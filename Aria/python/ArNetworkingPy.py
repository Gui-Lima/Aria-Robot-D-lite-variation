...
class ArClientBase(AriaPy.ArASyncTask):
    ...
    def requestOnceWithInt16(self, *args):
        """requestOnceWithInt16(self, char name, Byte2 val) -> bool"""
        return _ArNetworkingPy.ArClientBase_requestOnceWithInt16(self, *args)

    def requestOnceWithInt32(self, *args):
        """requestOnceWithInt32(self, char name, Byte4 val) -> bool"""
        return _ArNetworkingPy.ArClientBase_requestOnceWithInt32(self, *args)

    def requestOnceWithDouble(self, *args):
        """requestOnceWithDouble(self, char name, double val) -> bool"""
        return _ArNetworkingPy.ArClientBase_requestOnceWithDouble(self, *args)
...
class ArClientHandlerRobotUpdate(_object):
    ...
    def addStatusChangedCB(self, *args):
        """addStatusChangedCB(self, ArFunctor2<(p.q(const).char,p.q(const).char)> cb)"""
        return _ArNetworkingPy.ArClientHandlerRobotUpdate_addStatusChangedCB(self, *args)

    def remStatusChangedCB(self, *args):
        """remStatusChangedCB(self, ArFunctor2<(p.q(const).char,p.q(const).char)> cb)"""
    ...
    def waitForStatus(self, *args):
        """waitForStatus(self, char status, long timeout) -> bool"""
        return _ArNetworkingPy.ArClientHandlerRobotUpdate_waitForStatus(self, *args)

    def waitForMode(self, *args):
        """waitForMode(self, char mode, long timeout) -> bool"""
        return _ArNetworkingPy.ArClientHandlerRobotUpdate_waitForMode(self, *args)
